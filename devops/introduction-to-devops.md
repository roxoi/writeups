...
# Introduction to DevOps: Your Starting Point

Every piece of software goes on a journey: it's written, packaged, shipped, and kept running. DevOps is the set of practices and tools that make that journey smooth instead of chaotic. At the center of that journey are two ideas that build directly on each other: **containerization**, so your app runs identically everywhere, and **orchestration**, so you can run thousands of those containers without losing your mind.

This page is the hub for the DevOps tutorials in this repo - bookmark it and work through the tutorials in order.
